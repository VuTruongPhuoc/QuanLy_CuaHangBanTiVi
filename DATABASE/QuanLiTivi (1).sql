...
insert tNhanVien values(N'NV004', N'Phạm Minh Quân', '2002-11-4', '0987654322', N'Hà Nội','quan','222', 0)
Go
insert tChiTietHDN values(N'HDN001',N'SP002', '2', null)
insert tChiTietHDN values(N'HDN001',N'SP003', '4', null)
insert tChiTietHDN values(N'HDN002',N'SP004', '6', null)
insert tChiTietHDN values(N'HDN002',N'SP005', '8', null)
GO
...
insert tChiTietHDN values(N'HDN002',N'SP005', '8', null)
GO
insert tChiTietHDB values(N'HDB001', N'SP002', '3', null)
insert tChiTietHDB values(N'HDB001', N'SP003', '1', null)
insert tChiTietHDB values(N'HDB002', N'SP004', '1', null)
insert tChiTietHDB values(N'HDB002', N'SP005', '1', null)
